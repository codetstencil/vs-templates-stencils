...
namespace ZeraSystems.CodeNanite.CleanArchitecture
{
    ...
    [CodeStencilCodeNanite(new[]
    {
        ...
        "This generates the DbSet for all the tables in the schema. "+
        "It takes this form : "+"\r\n"+
        "public DbSet<ToDoItem> ToDoItems { get; set; }",  // 2
        "1.0",                                                                  // 3
        "GetDbSet",                                                             // 4
    ...
    public partial class GetDbSet : ExpansionBase, ICodeStencilCodeNanite
    {
