...
namespace ZeraSystems.CodeNanite.WebAPI
{
    ...
    [CodeStencilCodeNanite(new[]
    {
        "ZERA Systems Inc.",
        "Bootstrap NavMenu",
        "Creates a BootStrap Nav Menu based on the Tables that have been configured to show",
        "1.0",
        "CreateNavMenu",
        "ZeraSystems.CodeNanite.Razor",
        "01/01/2018",
        "CREATE_NAV_MENU",
        "1",
        "",
    ...
    public partial class CreateNavMenu : ExpansionBase, ICodeStencilCodeNanite
    {
